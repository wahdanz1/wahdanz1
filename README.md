...
| [hackaton-2025-project][hackaton-2025-tag]   | A 4 week Hackaton completed during June 2025 where we built a dashboard based on the WoW API. |
| [taxi-prediction-fullstack][taxi-prediction-tag]   | A full-stack application with machine learning prediction model for taxi price estimation, featuring FastAPI backend, interactive frontend, and data visualization. |
...
[taxi-prediction-tag]: https://github.com/wahdanz1/taxi-prediction-fullstack-daniel-opa24
